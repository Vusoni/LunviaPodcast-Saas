...
export function getCurrentPlan(
  ...
  if (hasFunction({ plan: "premium" })) {
    return "premium";
  }
  if (hasFunction({ plan: "standard" })) {
    return "standard";
  }
  return "free";
}
 ...
 *
 * @param hasFunction - The `has` function from useAuth() or useUser()
 * @returns Recommended upgrade plan name or null if already on premium
 */
export function getUpgradePlan(
  ...
  if (currentPlan === "free") return "standard";
...
export function getUpgradeCTA(
  ...
  if (upgradePlan === "standard") return "Upgrade to Pro";
  if (upgradePlan === "premium") return "Upgrade to premium";
  return "premium Plan"; // Already on premium
}
