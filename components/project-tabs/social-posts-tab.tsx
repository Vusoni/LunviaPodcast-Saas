...
interface SocialMediaPostsTabProps {
	SocialMediaPosts?: {
		twitter: string;
		linkedin: string;
		instagram: string;
...
export function SocialMediaPostsTab({
	SocialMediaPosts,
}: SocialMediaPostsTabProps) {
	const { copy, isCopied } = useCopyToClipboard();

	// TabContent ensures this is never undefined at runtime
	if (!SocialMediaPosts) return null;
