...
import { SocialMediaPostsTab } from "@/components/project-tabs/social-posts-tab";
...
import { VideoTimestampsTab } from "@/components/project-tabs/Video-timestamps-tab";
			...
			<div className="grid gap-6">
				...
				{(showGenerating || isCompleted) && (
					...
					>
						...
						<TabsContent value="Video-timestamps" className="space-y-4">
							<TabContent
								isLoading={showGenerating}
								data={project.VideoTimestamps}
								error={project.jobErrors?.VideoTimestamps}
								projectId={projectId}
								feature={FEATURES.Video_TIMESTAMPS}
								featureName="Video Timestamps"
								jobName="VideoTimestamps"
								emptyMessage="No Video timestamps available"
							>
								<VideoTimestampsTab timestamps={project.VideoTimestamps} />
							</TabContent>
						</TabsContent>
						...
						<TabsContent value="social" className="space-y-4">
							<TabContent
								isLoading={showGenerating}
								data={project.SocialMediaPosts}
								error={project.jobErrors?.SocialMediaPosts}
								projectId={projectId}
								feature={FEATURES.SOCIAL_MEDIA_POSTS}
								featureName="Social Posts"
								jobName="SocialMediaPosts"
								emptyMessage="No social posts available"
							>
								<SocialMediaPostsTab
									SocialMediaPosts={project.SocialMediaPosts}
								/>
							</TabContent>
						</TabsContent>
